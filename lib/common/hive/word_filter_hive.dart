...
Future<WordFilterModel> loadSettingFromHive(Ref<Object?> ref) async {
  final box = await ref.read(boxProvider('word_book_setting').future);
  final WordFilterModel settingData =
      box.get('word_book_setting', defaultValue: defaultModel);
...
Future<WordFilterModel> updateMaskSettingInHive(
  ...
  await box.put('word_book_setting', updatedSetting);
